...
# For demonstration purposes, I will use some hardcoded unique values or recreate them if `df` is available
# from the notebook state. If `df` or `df_encoded` is available globally, I can use that.
